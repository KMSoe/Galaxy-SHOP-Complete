...
async function createTables(){
    try {
        ...
        await pool.execute(`create table if not exists cart_items(id int primary key auto_increment, productId int,cartId int,quantity int,foreign key(productId) references products(id),foreign key(cartId) references carts(id))`);
